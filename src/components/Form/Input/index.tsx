...
export function Control(props: InputControlProps) {
  return (
    <input
      className="flex-1 border-0 border-transparent bg-transparent p-0 text-zinc-900 placeholder-zinc-600 outline-none focus-within:ring-0 dark:text-zinc-100 dark:placeholder-zinc-400"
      {...props}
    />
  )
}
